...
with col2:
    st.title("Mid-Table Teams Analysis menggunakan K-Means dengan PCA Clustering")

with st.expander("Penjelasan Klaster"):
    st.markdown("""
    Klaster Mid-Table terdiri dari tim dengan performa rata-rata yang kompetitif namun tidak dominan. Posisi klasemen berada pada tingkat menengah, dengan tingkat kemenangan rendah–menengah. Tim dalam klaster ini menunjukkan kelemahan pada fase menyerang dan penguasaan bola, tetapi memiliki pertahanan yang relatif stabil serta kontribusi kiper yang cukup baik. Ketidakseimbangan antar fase permainan membuat klaster ini mencerminkan tim papan tengah yang mampu bertahan di liga, tetapi belum cukup kuat untuk bersaing di papan atas.
    """)
...
df_cluster2 = load_data("Data\Cluster\kmeans_cluster2.xlsx")
