...
with col2:
    st.title("Mid-Table Teams Analysis menggunakan Hierarchical dengan PCA Clustering")

with st.expander("Penjelasan Klaster"):
    st.markdown("""
    Klaster Mid-Table terdiri dari tim dengan performa moderat dan relatif stabil. Sebagian besar variabel berada pada tingkat menengah hingga menengah-tinggi, mencerminkan keseimbangan antara kekuatan dan kelemahan. Tim dalam klaster ini memiliki tingkat kemenangan yang sedang, produktivitas gol yang terbatas, tetapi menunjukkan performa pertahanan dan kontribusi kiper yang cukup solid. Dengan penguasaan bola dan kreativitas serangan yang tidak dominan, klaster ini merepresentasikan tim papan tengah yang kompetitif namun belum mampu menembus level tim elit.
    """)
...
df_cluster2 = load_data("Data/Cluster/hier_cluster2.xlsx")
